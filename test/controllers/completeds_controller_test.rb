...
class CompletedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create completed" do
    assert_difference('Completed.count') do
      post completeds_url, params: { completed: { last_touched: @completed.last_touched, true: @completed.true } }
    end
  ...
  test "should update completed" do
    patch completed_url(@completed), params: { completed: { last_touched: @completed.last_touched, true: @completed.true } }
