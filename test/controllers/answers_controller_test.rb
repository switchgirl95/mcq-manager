...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { answer: @answer.answer, correct: @answer.correct } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { answer: @answer.answer, correct: @answer.correct } }
